...
//   console.log('🚀 ~ exports.googleAuth= ~ url:', authorizeUrl);
...
// exports.googleresponse = async (req, res, next) => {
//   const code = req.query.code;
//   console.log('🚀 ~ exports.googleresponse= ~ code:', code);
...
//     console.log("🚀 ~ exports.googleresponse= ~ user:", user)
//     const userData = await getUserData(oAuth2Client.credentials.access_token);

//     // const userEmail = userData.email
  
//     const userDatabase = await User.findOne({ email: userData.email }).select('+password');
...
//     } else {
//       // Use userDatabase instead of newUser in the else block
//       const token = signToken(user._id);
